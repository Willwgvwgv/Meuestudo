  ...
  const highlights = [
    {
      ...
      text: 'Tarefas, calendário e sessões de foco em um só lugar.',
    },
    {
      icon: <BookOpen className="w-4 h-4" />,
      title: 'Caderno completo',
      text: 'Anotações ricas, modelos prontos e exportação em vários formatos.',
    },
    {
      icon: <Sparkles className="w-4 h-4" />,
      title: 'Questões geradas por IA',
      text: 'Pratique com exercícios sob medida para o seu tópico de estudo.',
    },
  ];

  return (
    <div className="min-h-screen w-full flex bg-[#f8fafc] text-[#191c1e] selection:bg-[#004ac6] selection:text-white font-sans antialiased">
      {/* Left: Branding hero panel (desktop only) */}
      <aside className="hidden lg:flex lg:w-[42%] xl:w-2/5 shrink-0 relative overflow-hidden bg-gradient-mesh text-white flex-col justify-between p-12 xl:p-14">
        <div className="relative z-10 flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-white/15 backdrop-blur-sm flex items-center justify-center ring-1 ring-white/25 shadow-lg shadow-black/10">
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="text-3xl xl:text-[2.5rem] font-extrabold leading-[1.1] tracking-tight mb-5">
            Organize seus estudos com clareza e constância.
          </h1>
          <p className="text-white/80 text-sm leading-relaxed mb-10">
            Acompanhe tarefas, matérias e desempenho com uma plataforma feita para manter o ritmo
            até o dia da prova.
          </p>
          ...
          <ul className="space-y-5">
            {highlights.map((h) => (
              <li key={h.title} className="flex items-start gap-3.5">
                <div className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center shrink-0 ring-1 ring-white/20">
                  {h.icon}
                </div>
                <div>
                  <p className="text-sm font-semibold">{h.title}</p>
                  <p className="text-xs text-white/70 mt-0.5 leading-relaxed">{h.text}</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <p className="relative z-10 text-xs text-white/60 flex items-center gap-2">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        {/* Top bar: mobile brand + Supabase config trigger */}
        <header className="w-full px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-200/80 lg:border-none bg-white/80 lg:bg-transparent backdrop-blur-md flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5 sm:gap-3 lg:hidden min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-tr from-[#004ac6] to-[#2563eb] text-white flex items-center justify-center shadow-md shadow-[#004ac6]/20 shrink-0">
              <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <div className="min-w-0">
              <span className="font-extrabold text-base sm:text-xl tracking-tight text-[#191c1e] block leading-tight truncate">
                Meu Estudo
              </span>
              <span className="hidden sm:block text-[11px] font-medium text-[#737686]">
                Plataforma Inteligente de Aprendizagem
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="ml-auto shrink-0 flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 transition-colors cursor-pointer"
            title="Ver credenciais de conexão do Supabase"
          >
            <Key className="w-3.5 h-3.5 text-[#004ac6] shrink-0" />
            <span className="hidden sm:inline">Configuração Supabase</span>
            ...
            {isSupabaseConfigured() ? (
              ...
              <span
                className="w-2 h-2 rounded-full bg-amber-500 ml-1 animate-pulse shrink-0"
